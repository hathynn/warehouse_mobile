...
// import { ImportOrderDetailStatus, ImportOrderDetailType } from "@/types/importOrderDetail.type";
...
//   const { importOrderDetails, fetchImportOrderDetails } = useImportOrderDetail();
//   const [filteredDetails, setFilteredDetails] = useState<ImportOrderDetailType[]>([]);
...
//   // Lưu vào redux khi fetch xong
//   useEffect(() => {
//     if (importOrderDetails && id) {
//       const mappedProducts = importOrderDetails
...
//           location:
//             item.status === ImportOrderDetailStatus.COMPLETED
//               ? { zone: "A", floor: "1", row: "B", batch: "5" }
//               : null,
//         }));
//       dispatch(setProducts(mappedProducts));
//     }
//   }, [importOrderDetails, id, dispatch]);
...
//                     <Text className="text-sm">Số lượng yêu cầu: {item.expect}</Text>
//                     <Text className="text-sm">Số lượng thực tế: {item.actual}</Text>
